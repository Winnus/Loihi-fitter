...
class VariableInterpreter():
    ...
    def __init__(self, equation):
        ...
        self.input_variable = ('I',mV)
        self.output_variable =('v',mV)
        self.synaptic_variable =('I',mV)
        ...
        self.variables_to_monitor = [] # names of the variables wich should be monitored.

    def get_identifier_names(self):
        try:
            return list(Equations(self.equation).identifiers)
    ...
    def assign_essential_variables(self, input_variable, output_variable, synaptic_variable, resting_variable, threshold, weight, dt, runtime):
        """
        Sets all the essential variables.
        
            input_variable : ("name_of_variable", unit)
            output_variable : ("name_of_variable", unit)
            synaptic_variable : ("name_of_variable", unit)
            resting_variable : "name_of_variable"
        ...
        self.synaptic_variable = synaptic_variable
    ...
    def set_monitoring_variables(self, monitors):
        """
        Tuple array of the variables that should be monitored.  
        monitors = [('myVar', unit), ('v', mV)]
        """
        self.variables_to_monitor = monitors
    ...
    def __str__(self):
        ...
        s+= 'synaptic_variable: '+str(self.synaptic_variable )+str('\n')
